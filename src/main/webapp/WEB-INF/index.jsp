...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		data-bs-ride="carousel" style="margin-top: 55px;">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="/assets/img/spyralcarusel.png" class="d-block w-100"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="/assets/img/kaijucarusel.png" class="d-block w-100"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="/assets/img/truedracocarusel.png" class="d-block w-100"
					alt="...">
			</div>
		</div>
	...
	<!--  -->
	<div id="LoMasVendido" class="d-flex justify-content-center mt-4"
	...
	<!--  -->
	<div id="OfertasDestacadas" class="d-flex justify-content-center mt-4"
		style="background-color: #312783; border-radius: 9px;">
