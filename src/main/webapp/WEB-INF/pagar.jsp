...
<body>
	...
	<!-- Form-Row -->
	<div class="d-flex container justify-content-center mb-5">
		<div class="card col-9 p-3">
			<img style="align-self: center;"
				src="https://www.sgcli.com/wp-content/uploads/2014/11/instalar-webpay-plus.png"
				alt="WebPay" width=80%>
			<p>Su pedido puede tardar aproximadamente 3 días en ser aceptado
				por el vendedor, de no ser respondido en el tiempo se le reembolsará
				el dinero durante todo este proceso, recibirá correos, y puede
				seguir el proceso en el cuál se encuentra su compra.</p>
